    ...
    public RefreshToken save(RefreshToken entity) {
        ...
        if (entity.getId() == null) {
            ...
            dsl.insertInto(REFRESH_TOKENS)
                    ...
                    .set(REFRESH_TOKENS.USER_ID, entity.getUserId())
                    .set(REFRESH_TOKENS.TOKEN, entity.getToken())
                    .set(REFRESH_TOKENS.EXPIRY_DATE, entity.getExpiryDate())
            ...
            dsl.update(REFRESH_TOKENS)
                    ...
                    .set(REFRESH_TOKENS.EXPIRY_DATE, entity.getExpiryDate())
                    .set(REFRESH_TOKENS.UPDATED_AT, now)
                    .where(REFRESH_TOKENS.ID.eq(entity.getId()))
                    .execute();
            entity.setUpdatedAt(now);
        }
        return entity;
